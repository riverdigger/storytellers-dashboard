...
import { PlayerList, PlayerListLoading } from "../../components/Player/PlayerList";
import { Schedule, ScheduleLoading } from "../../components/Schedule/Schedule";
    ...
    return (
      <div className="flex justify-between items-start w-full h-full text-light py-8 px-72">
        ...
        <div className="flex flex-col justify-start items-center">
          ...
          <div className="flex flex-col justify-start items-start w-full mt-4 h-16 bg-theme-purple-500 animate-pulse rounded-xl p-2 shadow-md">
          </div>
        </div>
        {/* Right Column */}
        <div className="flex flex-col justify-between items-start w-full h-full grow ml-8">
          <div className="flex justify-between items-start w-full h-full grow mb-4">
            <div className="flex flex-col justify-start items-start grow">
              <h1 className="rounded-md bg-theme-purple-500 animate-pulse h-16 w-full"></h1>
              <h2 className="rounded-md bg-theme-purple-500 animate-pulse h-10 w-48 mt-1"></h2>
            </div>
            <ScheduleLoading></ScheduleLoading>
          </div>
          <div className="flex flex-col justify-start items-start w-full h-full grow">
            <h2 className="rounded-md bg-theme-purple-500 animate-pulse h-8 w-36 mb-1"></h2>
            <p className="rounded-md bg-theme-purple-500 animate-pulse h-64 w-full"></p>
          </div>
