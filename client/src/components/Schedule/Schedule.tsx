...
const Schedule: React.FC<ScheduleProps> = ({
    ...
    return (
        <div className="flex justify-center items-center bg-light-purple-1000 rounded-xl shadow-md px-4 pb-4 pt-2">
            <FontAwesomeIcon icon={faCalendarAlt} className="text-6xl text-white mr-4" />
